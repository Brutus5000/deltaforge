...
public enum ErrorCode {
    ...
    REPOSITORY_FIXED(106, "Repository fixed", "The associated repository can not be changed after creation."),
    BRANCH_NOT_FOUND(107, "Branch not found", "There is no branch with id  ''{0}''."),
    BRANCH_NAME_IN_USE(108, "Branch name in use", "The branch name ''{1}'' is already in use in repository ''{0}''."),
    BRANCH_BASELINE_FIXED(109, "Branch initialBaseline fixed", "You cannot change the initial initialBaseline after creation."),
