...
import net.brutus5000.deltaforge.server.resthandler.RepositoryEventHandler;
...
//        }
        ...
        class WhenUpdating {
            ...
            void thenHandleBeforeSaveShouldFailOnNameAlreadyInUse() {
                ...
                MatcherAssert.assertThat(exception, ApiExceptionWithMultipleCodes.apiExceptionWithCode(ErrorCode.REPOSITORY_NAME_IN_USE));
            }
            ...
            void thenHandleBeforeSaveShouldFailOnGitUrlAlreadyInUse() {
                ...
                MatcherAssert.assertThat(exception, ApiExceptionWithMultipleCodes.apiExceptionWithCode(ErrorCode.REPOSITORY_GIT_URL_IN_USE));
            }
            ...
            void thenHandleBeforeSaveShouldFailOnChangingInitialBaseline() {
                ...
                MatcherAssert.assertThat(exception, ApiExceptionWithMultipleCodes.apiExceptionWithCode(ErrorCode.REPOSITORY_BASELINE_FIXED));
            }
