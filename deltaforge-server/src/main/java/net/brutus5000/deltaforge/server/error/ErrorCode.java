...
public enum ErrorCode {
    ...
    BRANCH_NOT_FOUND(108, "Branch not found", "There is no branchDto with id  ''{0}''."),
    BRANCH_NAME_IN_USE(109, "Branch name in use", "The branchDto name ''{1}'' is already in use in repository ''{0}''."),
    ...
    TAG_ALREADY_ASSIGNED(114, "Tag already assigned", "The tag id ''{0}'' is alrady assigned to branchDto ''{1}''."),
