...
public enum ErrorCode {
    ...
    CHANNEL_NOT_FOUND(108, "Channel not found", "There is no channel with id  ''{0}''."),
    CHANNEL_NAME_IN_USE(109, "Channel name in use", "The channel name ''{1}'' is already in use in repository ''{0}''."),
    ...
    TAG_ALREADY_ASSIGNED(114, "Tag already assigned", "The tag id ''{0}'' is alrady assigned to channelDto ''{1}''."),
    ...
    REPOSITORY_BASELINE_MISSING(117, "Repository baseline missing", "Repository ''{0}'' has no baseline set. Setup the baseline tag first.");
